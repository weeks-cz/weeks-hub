...
import { LayoutDashboard, Kanban, Calendar, Tent, FileText, BarChart3, Shield, GraduationCap, ClipboardList, User, LogOut, Package, Baby } from 'lucide-react';
...
export function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex flex-col w-[260px] h-screen bg-[var(--bg-surface)] border-r border-[var(--border-default)] fixed left-0 top-0 z-30 print:hidden">
      {/* Logo → Dashboard */}
      <Link
        ...
        {isAdmin(user?.role) && (
          <>
            ...
            >
              ...
              <span className="relative z-10">Registrace</span>
            </Link>
            <Link
              href={ROUTES.deti}
              className={cn(
            ...
            >
              ...
              <span className="relative z-10">Děti</span>
            </Link>
            <Link
              href={ROUTES.admin}
              className={cn(
